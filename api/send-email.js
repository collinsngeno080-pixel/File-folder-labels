    ...
    try {
        ...
        const thankyouEmailContent = `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#333;line-height:1.6;">
                <h2 style="color:#ff6b2b;">Thank You for Contacting File Lable Pro</h2>
                ...
                <p>Best regards,<br/><strong>File Lable Pro Support Team</strong></p>
                <p style="color:#999;font-size:12px;">File Lable Pro | Email: ${esc(TO_EMAIL)}</p>
            </div>
        `;
        ...
        await Promise.all([
            axios.post(sendMailUrl, {
                message: {
                    subject: `[File Lable Pro] New inquiry from ${firstName} ${lastName}`,
            ...
            axios.post(sendMailUrl, {
                message: {
                    subject: `[File Lable Pro] Lead intel - ${firstName} ${lastName}`,
            ...
            axios.post(sendMailUrl, {
                message: {
                    subject: `We've Received Your Inquiry - File Lable Pro Support`,
                    body: { contentType: 'HTML', content: thankyouEmailContent },
                    toRecipients: [{ emailAddress: { address: email } }],
                    replyTo: [{ emailAddress: { address: TO_EMAIL, name: 'File Lable Pro Support' } }],
                },
